...
import { WrapperHeader, WrapperHeaderContent, HeaderButtonWrapper, ColumnWrapperHeader, MenuIcon, StyledInlineWrapper, CrossIcon, SwitchWrapper, SingleSwitch } from "./styles";
    ...
    return (
        <WrapperHeader>
            ...
            <WrapperHeaderContent isActive={isActive}>
                ...
                <StyledInlineWrapper>
                    <HeaderButtonWrapper onClick={()=> navigateTo('/')}><p>{t('Header.Coins')}</p></HeaderButtonWrapper>
                    <HeaderButtonWrapper onClick={()=> navigateTo('/about')}><p>{t('Header.About')}</p></HeaderButtonWrapper>
                </StyledInlineWrapper>

                <StyledInlineWrapper>
                    <SwitchWrapper>
                        <SingleSwitch onClick={()=> switchLng('en')} set={language==='en'}>{t('Header.en')}</SingleSwitch>
                        <SingleSwitch onClick={()=> switchLng('ru')} set={language==='ru'}>{t('Header.ru')}</SingleSwitch>
                    </SwitchWrapper>
